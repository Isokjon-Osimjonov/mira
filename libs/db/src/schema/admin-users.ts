...
export const rolePermissions = pgTable('role_permissions', {
  ...
  uniqueRoleResourceAction: uniqueIndex('role_permissions_unique_idx').on(t.roleId, t.resource, t.action),
  actionCheck: check('role_permissions_action_check', sql`${t.action} IN ('read', 'write', 'delete')`),
}));
